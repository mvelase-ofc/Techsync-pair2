...
router.get('/', async (req, res) => {
    ...
    async function TECHSYNC_PAIR_CODE() {
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'Techsync-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of Techsync 
...
⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Techsync GitHub Repo](Github.com/mvelase-ofc/)  

🚀 _Thanks for choosing Techsync — Let the automation begin!_ ✨`;

                    await Malvin.sendMessage(Malvin.user.id, { text: TECHSYNC_TEXT }, { quoted: session });
